...
A diferencia del cifrado César, que aplica un desplazamiento fijo a todas las letras, este método utiliza un sistema alternado que modifica cada carácter de forma distinta según su posición dentro del mensaje.
...
El algoritmo se basa en aplicar una suma o resta al valor ASCII de cada carácter del mensaje, dependiendo de si su posición es par o impar.
